...
```{r}
## Phyllostomidae species considered XY marked in black, XAfusions marked in blue, XAYAfusions marked in purple
color <- recode(tetrapodtraits.phyllostom$sex, "XY" = "black", "XAYAfusion" = "#CC79A7", "XAfusion" = "#56B4E9")
