...
tetrapodtraits <- read.csv(file = "TetrapodTraits_v2.0.1.csv", stringsAsFactors = FALSE)
...
```{r}
mammal.phylo <- read.nexus(file = "MamPhy_fullPosterior_BDvr_Completed_5911sp_topoCons_NDexp_MCC_v2_target.tre")
...
write.tree(herpestidae.tree, file = "herpestidae_tree.txt")
```
...
write.tree(phyllostom.tree, file = "phyllostom_tree.txt")
```
...
write.tree(sorex.tree, file = "sorex_tree.txt")
```