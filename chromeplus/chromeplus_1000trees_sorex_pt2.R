...
results <- foreach(i = 501:1000, .errorhandling="remove", .packages = c("chromePlus", "diversitree"), .combine = rbind) %dopar% {
...
saveRDS(results, "sorex1000_pt2.rds")
write.table(results, "sorex1000_pt2.txt")
